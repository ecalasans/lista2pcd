...
int main(void) {
   ...
   double inicio, fim, intervalo, tempo_min;
   ...
   printf("Tempo do processo %i = %f\n", my_rank, intervalo);

   MPI_Reduce(&intervalo, &tempo_min, 1, MPI_DOUBLE, MPI_MIN, 0, MPI_COMM_WORLD);
   ...
   if (my_rank == 0) {
      ...
      printf("of the integral from %f to %f = %.15e\n",
          a, b, total_int);      
      printf("Tempo decorrido no cálculo = %f ms\n", tempo_min * 1000);
   }
